            ...
            <div class="x_content">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active in" id="formvn" role="tabpanel" aria-labelledby="formvn-tab">
                        @include('admin.pages.category_article.form-vi')
                    </div>
                    <div class="tab-pane fade" id="formen" role="tabpanel" aria-labelledby="formen-tab">
                        @include('admin.pages.category_article.form-en',['itemEn'=>$itemEn])
                    </div>
                </div>
                @include('admin.pages.category_article.form-merged')
            </div>
        </div>
    </div>
