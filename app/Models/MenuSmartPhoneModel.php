...
use Config;
class MenuSmartPhoneModel extends AdminModel
{
    public function __construct(){
        $this->table                = 'menuSmartPhone as m';
        $this->folderUpload         = 'menuSmartPhone';
