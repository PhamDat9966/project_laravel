...
use App\Models\MenuSmartPhoneModel as MainModel;
use App\Http\Requests\MenuRequest as MainRequest;
use App\Http\Controllers\Admin\AdminController;

use App\Models\CategoryProductModel;

class MenuSmartPhoneController extends AdminController
{
    public function __construct()
    {
        $this->pathViewController   = 'admin.pages.menuSmartPhone.';
        $this->controllerName       = 'menuSmartPhone';
